...
RegisteredRadioButtonPair::RegisteredRadioButtonPair(Glib::ustring const &label,
...
RegisteredPoint::RegisteredPoint(Glib::ustring const &label, Glib::ustring const &tip,
                                 Glib::ustring const &key, Registry &wr,
                                 Inkscape::XML::Node * const repr_in, SPDocument * const doc_in)
